...
public class User implements Serializable {
  ...
  */
  ...
  private java.lang.Integer weekly_availability;
  ...
  */
  ...
  private java.lang.Integer weekly_availability_min;

  /**
  * @generated
  */
  @Temporal(TemporalType.TIMESTAMP)
  @Column(name = "creation_date", nullable = true, unique = false, insertable=true, updatable=true)
  
  private java.util.Date creation_date = new Date();
  ...
  /**
   * Obtém weekly_availability
   * return weekly_availability
   * @generated
   */
  
  public java.lang.Integer getWeekly_availability(){
    return this.weekly_availability;
  }

  /**
   * Define weekly_availability
   * @param weekly_availability weekly_availability
   * @generated
   */
  public User setWeekly_availability(java.lang.Integer weekly_availability){
  ...
  /**
   * Obtém weekly_availability_min
   * return weekly_availability_min
   * @generated
   */
  
  public java.lang.Integer getWeekly_availability_min(){
    return this.weekly_availability_min;
  }

  /**
   * Define weekly_availability_min
   * @param weekly_availability_min weekly_availability_min
   * @generated
   */
  public User setWeekly_availability_min(java.lang.Integer weekly_availability_min){
    this.weekly_availability_min = weekly_availability_min;
    return this;
  }
   ...
   * @generated
   */
  public User setCreation_date(java.util.Date creation_date){
